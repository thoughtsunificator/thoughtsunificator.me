...
"Use (<a href='https://solid-is-not-solid.com/'>wisely</a>) principles such as the Separation Of Concerns as a mean to establish a clear definition of what each part of the software's job is. The cutting corners mindset should be antagonized. Own these hard to grasp concepts.",
...
"While experimenting is most certainly always a good idea, <a href='http://motherfuckingwebsite.com/'>try not to fall for the overcomplicate things mindset trap</a>.",
...
"Any software attempting to \"solve\" a problem bigger than himself should never be trusted in the first place. I consider Swiss Army knife softwares as evil. <a href='https://cscie2x.dce.harvard.edu/hw/ch01s06.html'>Do one thing and do it well</a>",
...
"Composability is everything.",
	...
	return `
<i>This is the configuration I am running on. More importantly, this should be the configuration you run on before you do any form of static analysis on my being. A never-ending monologue that will swallow any foreign body. Basically, this is the A to Z to living and witch crafting as an open 🧙.</i>
